...
# It follows vH1, but with this adjustment:
#   Test set is not random but is class_year of 2024 or 2025

# Possible improvements include:
#   Re-encode year values as "years since baseline"
#   Use multiple temporal folds (e.g., train on years 1-10, test on 11; train on 1-15, test on 16, etc.)
...
lapply(target_classes,
       ...
       function(target){
         ...
         saveRDS(theData, here::here("Data", paste("Decision Tree vH2", target, "Data.rds")))
         ...
         saveRDS(fit, here::here("Models", paste("Decision Tree vH2", target, "model.rds")))
