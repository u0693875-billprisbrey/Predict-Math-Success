...
# It follows vF2, but with slight adjustments:
#   Binary and Trinary target classes aren't used
#   Filter out >3000 level math courses
#   Filter out math courses that haven't been taken since 2020
#   Filter out the toddlers; AGE < 12
#   Light feature engineering:
#       Add course level
#       Convert age into buckets
#       Add class volume clusters


# Staying the same:
#   Filter out math courses taken less than -0.5 yr_diff
#   Converts APCREDIT values of NA to zero, per e-mail convo with Luis--

# To do:
#   Repeat without course load  
...
lapply(target_classes,
       ...
       function(target){
         ...
         saveRDS(theData, here::here("Data", paste("Decision Tree vH0", target, "Data.rds")))
         ...
         saveRDS(fit, here::here("Models", paste("Decision Tree vH0", target, "model.rds")))
