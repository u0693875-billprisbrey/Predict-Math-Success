...
# vD1 differs from vD0 in that I drop unused factor levels in the target 
# "course_option".  I'm not running D1 today and I might never, but the correction
# is saved and documented.

# vD0 follows vC1, and vJ0 for the iterative annual aspect 
...
optionsData_top90$course_option <- droplevels(optionsData_top90$course_option)
