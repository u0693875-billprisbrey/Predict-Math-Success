...
# It follows vC0, and vJ0 for the iterative annual aspect 
...
# This vC1 differs from vC0 in that "course_level" is removed as a predictor.
...
saveRDS(theData, here::here("Data","Over Time", paste("Decision Tree Courses vC1", testYear, "Data.rds")))
...
saveRDS(fit, here::here("Models", "Over Time", paste("Decision Tree Courses vC1", testYear, "model.rds")))
