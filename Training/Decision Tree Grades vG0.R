...
lapply(target_classes,
       ...
       function(target){
         ...
         saveRDS(theData, here::here("Data", paste("Decision Tree vG0", target, "Data.rds")))
         ...
         saveRDS(fit, here::here("Models", paste("Decision Tree vG0", target, "model.rds")))
