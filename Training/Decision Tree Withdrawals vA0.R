...
#     - It is a binary model predicting "W" or not.
#     - Instead of "cleanData", data prep is modified to include "W" grade
...
saveRDS(theData, here::here("Data", paste("Decision Tree vA0", target, "Data.rds")))
...
saveRDS(fit, here::here("Models", paste("Decision Tree vA0", target, "model.rds")))
