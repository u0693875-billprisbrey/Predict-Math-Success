...
# It follows vB0, but with this adjustment:
#   - It includes "load" refering to credit load as a prediction variable

# The test set is not random but is class_year of 2024 or 2025 (like VH2).
...
saveRDS(theData, here::here("Data", paste("Decision Tree vB0", target, "Data.rds")))
