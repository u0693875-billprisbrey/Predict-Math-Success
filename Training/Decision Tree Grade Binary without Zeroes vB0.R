# Decision Tree Grade Binary without Zeroes vB0
...
# It follows Decision Tree Grade Binary without Zeroes vA0, but with these adjustments:
#   - Binary isolates a grade of "D" (between 0.7 and 1.3 inclusive)  

# As with the prior model: 
