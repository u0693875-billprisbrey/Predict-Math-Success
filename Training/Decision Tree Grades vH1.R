...
# It follows vH0, but with this adjustment:
#   Course load is removed as a predictor
...
lapply(target_classes,
       ...
       function(target){
         ...
         saveRDS(theData, here::here("Data", paste("Decision Tree vH1", target, "Data.rds")))
         ...
         saveRDS(fit, here::here("Models", paste("Decision Tree vH1", target, "model.rds")))
