...
displayCourseAlternatives(data = tg2, unid = "01487355", dist_cutoff = NA, closest_cutoff = NA, legend_params = list(inset = c(-0.17,0)), risk_legend_params = list(inset = c(-0.05,0)) )
