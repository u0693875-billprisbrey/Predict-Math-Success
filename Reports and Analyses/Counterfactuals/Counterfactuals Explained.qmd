...
change "Course medians in 2023" to "Median qualifications per course (year 2023)"
...
mtext(side = 3,
      text = "Prediction accuracy decreases with distance",
      font  = 3,
      cex = 1.4,
      line = 0.8)
...
displayCourseAlternatives(data = tg2,
                          unid = "01487355",
                          dist_cutoff = NA,
                          closest_cutoff = NA,
                          legend_params = list(inset = c(-0.17,0)),
                          risk_legend_params = list(inset = c(-0.05,0))
                          ) 
