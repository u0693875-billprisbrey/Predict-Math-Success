...
::: {.cell}
::: {.cell-output-display}
![GPA with distance](Counterfactuals-Explained_files/figure-html/fig-GPA-1.png){#fig-GPA width=1056}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Prediction accuracy with distance](Counterfactuals-Explained_files/figure-html/fig-errors-1.png){#fig-errors width=1056}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Distance as a cumulative percentage](Counterfactuals-Explained_files/figure-html/fig-cuml-perc-1.png){#fig-cuml-perc width=1056}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Median qualifications of successful students per course (year 2023)](Counterfactuals-Explained_files/figure-html/fig-course-scatter-1.png){#fig-course-scatter width=624}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Counterfactual grade predictions per course](Counterfactuals-Explained_files/figure-html/fig-counterfactual-1.png){#fig-counterfactual width=672}
:::
:::
...
::: {#tbl-student .cell tbl-cap='Incoming student qualifications'}
::: {.cell-output-display}
`````{=html}
...
::: {#tbl-distance .cell tbl-cap='Distance to median successful student and predicted grades'}
::: {.cell-output-display}
`````{=html}
