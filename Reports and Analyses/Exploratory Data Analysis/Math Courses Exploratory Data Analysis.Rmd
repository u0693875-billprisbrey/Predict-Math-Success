...
## OBJECTIVES   
  ...
  (1)  Identify highest enrollment math courses
...
Hierarchical clustering identifies seven more high enrollment courses differentiated by a natural break (as can be seen in the graphic, "Course attendance broken into three clusters.")  These courses are Math 1220, 1030, 1060, 2210, 1090, 1070, and 2250.
...
grid.text("Z-score",  x = unit(0.95, "npc"), rot = 270)
...
Count of repeat students per course and the number of DFWI students per course may be good indicators of poor math placement.    
