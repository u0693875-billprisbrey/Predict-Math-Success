...
mtext(outer = TRUE, side = 3, line = 0.5, font = 2, text = "Instructor Mean GPA by Number of Students (Log Scale)")
...
teachersBySig |>
  ...
  as.matrix() |>
    pheatmap(
      main = "Count of instructors by mean GPA shift and z-score",
