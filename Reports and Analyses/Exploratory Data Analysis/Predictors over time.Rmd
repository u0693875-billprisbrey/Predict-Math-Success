...
mtext(side = 3, 
      ...
      cex=1.7)
mtext(side = 3, 
      text = "Students enrolled in initial math courses have steadily increased.", 
      line = 1.2, 
      font = 3,
      cex = 1.1)
mtext(side = 2,
...
mtext(side = 3, 
      text = "Enrollment over time broken by course enrollment",
      line = 2.8,
      font = 2, 
      cex=1.5)
mtext(side = 3, 
...
overTime(data = cleanData[cleanData$vol_cluster == "hi_vol" & remove2025,],
         ...
         title = "Enrollment in 1010 has declined while the others, esp 1090, have increased")
mtext(side = 3, 
      ...
      cex=1.5)
mtext(side = 3, 
      text = "Enrollment in 1010 has declined while the others, esp 1090, have increased.", 
      line = 1.2, 
      font = 3)
mtext(side = 2,
      text = "Count of students",
...
lapply(unique(score_submission$vol_cluster), function(clust){
  ...
  lines(x = score_submission$class[lineFilter],
     ...
     lwd = 3,
     lty = 1,
     col = c("darkseagreen3", "lightgoldenrod3")[factor(score_submission$vol_cluster)[lineFilter]]
     )
})
)
...
legend(x="topright",
       ...
       col = c("darkseagreen3", "lightgoldenrod3"),
       pch = 19,
       pt.cex = 3)

mtext(side = 2, text = "Fraction of enrollment", line=3, cex = 1.2)
mtext(side =3, text = "Fraction of students submitting ACT math scores", line = 1.2, cex = 1.5, font = 2)
...
overTime(data=cleanData[remove2025,], variable = "GRADEGPA", by = "submitted", agg = "median", title = "Median math grade by test submission over time")

overTime(data=cleanData[remove2025,], variable = "GRADEGPA", by = "submitted", agg = "sd", title = "Math grade standard deviation by test submission over time")
...
medHSGPA <- overTime(data=cleanData[remove2025,], variable = "HSGPA", by = "submitted", agg = "median", title = "Median high school GPA by test submission over time")

overTime(data=cleanData[remove2025,], variable = "HSGPA", by = "submitted", agg = "sd", title = "Math grade standard deviation by test submission over time")
...
boxplot(ACTMATH ~ droplevels(course),
        data = cleanData[cleanData$vol_cluster == "hi_vol" & cleanData$class_year == 2024,],
