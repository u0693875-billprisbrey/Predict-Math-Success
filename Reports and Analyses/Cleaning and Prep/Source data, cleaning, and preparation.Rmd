...
New features were engineered: 
  ...
  * A new field *"dist"* was calculated as the Euclidean distance in median-centered z-scores, using the medians from the prior year's 'successful' students.  It is the square root of the squared ACT math difference plus the squared high school GPA difference.  
