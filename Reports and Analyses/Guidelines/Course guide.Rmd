...
*Additional work* 
  ...
  - Investigate whether higher HSGPA and ACTMATH than course median predicts lower grades (suggesting that students should be bumped up if they are >75th or >90th percentiles for a course)   
  - Train a new predictive model that incorporates z-score distance.  
...
# Demonstration:  Predicted grades  (To be added)

Given a student's identification number, grades can be roughly predicted by course with a wide margin of error.   
...
# First, let's worry about this tomorrow
