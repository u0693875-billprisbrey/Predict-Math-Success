...
aligned[["GRADEGPA"]][["cut"]] <- cut(aligned[["GRADEGPA"]][["pred"]], breaks = c(0,2.7,4))
...
createCM(aligned[["GRADEGPA"]], cuts = c(0,2.7,4)) |> drawCM() # HIGHEST KAPPA! 0.41
...
createCM(aligned[["GRADEGPA"]], cuts = c(0,2.7,4)) |> drawCM(title = "Binary optimum")
...
boxplot(ACTMATH.z ~ GRADEGPA, data = data_list[["GRADEGPA"]][["training"]], outline=FALSE)
