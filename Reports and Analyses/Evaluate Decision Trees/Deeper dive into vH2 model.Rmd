...
missingTraining <- function(target) {
...
createConfusionMatrix <- function(pred, reference, thresholds = NA, plot_title = "Predicted vs Actual"){
  ...
  discrete_predictions <- cut(pred, thresholds)
  discrete_references <- cut(reference, thresholds)
  
  # create confusion matrix
  
  cm <- confusionMatrix(factor(discrete_predictions), factor(discrete_references), mode = "everything")
  
  return(cm)
  
}

gradeMissing <- missingTraining("GRADEGPA")  
...
print(GRADEGPA_cm)
# drawCM(GRADEGPA_cm) # error, annoyingly

quadMissing <- missingTraining("grade_quad")  
